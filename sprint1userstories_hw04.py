...
def Marriage_before_HusbDeath():
    for key, value in fam_dict.items():
        ...
        if husb_deathdate_datetime < marr_date_datetime:
            print "Error: US 05: Death date of husband (" , husb_deathdate_datetime, ") before marriage date (", marr_date, ")" "\n"
            return True
...
def Marriage_before_WifeDeath():
    for key, value in fam_dict.items():
        ...
        if wife_deathdate_datetime < marr_date_datetime:
            print "Error: US 05: Death date of wife (" , wife_deathdate_datetime, ") before marriage date (", marr_date, ")" "\n"
            return True
...
def Divorce_before_HusbDeath():
    for key, value in fam_dict.items():
        ...
        if husb_deathdate_datetime < div_date_datetime:
            print "Error: US 06: Death date of husband (" , husb_deathdate_datetime, ") before divorce date (", div_date, ")" "\n"
            return True
...
def Divorce_before_WifeDeath():
    for key, value in fam_dict.items():
        ...
        if wife_deathdate_datetime < div_date_datetime:
            print "Error: US 06: Death date of wife (" , wife_deathdate_datetime, ") before divorce date (", div_date, ")" "\n"
            return True
            
class US0506Test(unittest.TestCase):
    def testUS05(self):
        self.assertTrue(Marriage_before_HusbDeath)
        self.assertTrue(Marriage_before_WifeDeath)
    def testUS06(self):
        self.assertTrue(Divorce_before_HusbDeath)
        self.assertTrue(Divorce_before_WifeDeath)
